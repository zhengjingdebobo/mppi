"""Corridor launch with external ref publisher + local-input MPPI.

Starts:
    - ddr_minimal_sim corridor scenario
...
Usage:
    ...
    ros2 launch exact_mppi_jax sim_corridor_external_ref_launch.py use_rviz:=false
"""
...
logger = get_logger("exact_mppi_jax_sim_corridor_external_ref_launch")
...
def generate_launch_description() -> LaunchDescription:
    ...
    global_ref_node = Node(
        ...
        parameters=[
            {"use_sim_time": True},
            {"mppi_config_file": "corridor_planner.yaml"},
        ],
    )
