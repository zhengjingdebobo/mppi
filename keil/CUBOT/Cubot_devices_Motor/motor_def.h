...
typedef enum
{
    OPEN_LOOP = 0x0,     // 0b0000 → 0x0
    CURRENT_LOOP = 0x1,  // 0b0001 → 0x1
    SPEED_LOOP = 0x2,    // 0b0010 → 0x2
    ANGLE_LOOP = 0x4,    // 0b0100 → 0x4

    // 组合模式
    SPEED_AND_CURRENT_LOOP = 0x3,  // 0b0011 → 0x3
    ANGLE_AND_SPEED_LOOP = 0x6,    // 0b0110 → 0x6
    ALL_THREE_LOOP = 0x7,          // 0b0111 → 0x7
} Closeloop_Type_e;

typedef enum
{
    FEEDFORWARD_NONE = 0x0,        // 0b00 → 0x0
    CURRENT_FEEDFORWARD = 0x1,     // 0b01 → 0x1
    SPEED_FEEDFORWARD = 0x2,       // 0b10 → 0x2
    CURRENT_AND_SPEED_FEEDFORWARD = CURRENT_FEEDFORWARD | SPEED_FEEDFORWARD,
} Feedfoward_Type_e;  // 修正拼写
